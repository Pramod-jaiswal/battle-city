...
hero_fire.y=480;
hero_fire.width=10;
hero_fire.height=10;// wall.element = 'wallofqueen';
// wall.x = 500;
// wall.y = 250;
...
function enemy1_shoot() {
  if (enemy1.y + enemy1.height == 300) {
    ...
    if(p == 2){
      enemy1_fire.x -= 20 * Math.sin(-(45 * Math.PI / 180));
      enemy1_fire.y += 20 * Math.cos(45 * Math.PI / 180);
    }
    else
    {
    ...
    if (collision_with_boundry(enemy1_fire) || collision_with_hero(enemy1_fire))
    {
...
function enemy2_shoot() {
  ...
  if (collision_with_boundry(enemy2_fire) || collision_with_hero(enemy2_fire))
  {
...
function enemy3_shoot() {
  ...
  if(r ==2)
  {
    enemy3_fire.x += 20 * Math.sin(-(45 * Math.PI / 180));
    enemy3_fire.y += 20 * Math.cos(45 * Math.PI / 180);
  }
  else {
  ...
  if (collision_with_boundry(enemy3_fire)||collision_with_hero(enemy3_fire))
   {
    reset_enemy3_fire();
  }
}
